...
(function() {
  ...
  Home = {
    init: function() {
      $('body').on('submit', '.landing-modal .edit_user', this.validateAndThankUser);
      $('body').on('submit', '#mentor-form .edit_user', this.validateAndThankMentor);
      $('body').on('click', '.close-modal', this.closeModal);
      $('body').on('click', '#apply-mentor', this.showMentorForm);
      $('body').on('click', '.landing-user-field.submit', this.saveUserInfoInSession);
      return $('body').on('click', '#mentors-link', this.showMentorsSection);
    },
    showMentorsSection: function() {
      return $.fn.fullpage.moveTo(2);
    },
    saveUserInfoInSession: function() {
      var form, isEmpty;
    ...
    showMentorForm: function() {
      ...
      return $('#mentor-form').show().addClass('animated fadeIn');
    },
    closeModal: function() {
      return $('.modal-overlay-container').hide();
    },
    validateAndThankMentor: function() {
      var isEmpty;
      isEmpty = false;
      $('.mentor-field').each(function() {
        var empty;
        empty = $(this).val() === "";
        if (empty) {
          isEmpty = true;
      ...
      return $('.modal-header-container').css('border-bottom', 'none');
    },
    validateAndThankUser: function() {
      var noDreamSchool, noEmail, noMajor;
      noDreamSchool = $('#user_dream_school').val() === "";
      noMajor = $('#user_major').val() === "";
      noEmail = $('#user_email').val() === "";
      if (false) {
        $('.modal-user-field').each(function() {
          if ($(this).val() === "") {
            return $(this).css('border', '1px solid red');
          }
        });
